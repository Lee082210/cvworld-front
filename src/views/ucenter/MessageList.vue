            ...
            <div class="message-item" v-if="data.messageType == 1">
              ...
              <div class="message-content">
                <div>
                  ...
                  对我的文章【
                  <router-link class="a-link" :to="`/post/${data.articleId}`">@{{ data.articleTitle }}</router-link>
                  】发表了评论
                  <span class="create-time">{{ data.createTime }}</span>
                </div>
                <div class="reply-content" v-html="data.messageContent">
                </div>
              </div>
            </div>
            <!-- 赞了我的文章 -->
